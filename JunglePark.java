...
/**
 * a graphical application that simulates the behavior of a set of animals (tigers, lions, deer, and
 * giraffes, for instance) in a jungle park
 * 
 * @author Mouna Kacem
 *
 */
public class JunglePark extends PApplet {
  ...
  public void setup() {
    ...
    // add tiger, deer, and clear buttons to the arraylist of graphic objects
